   ...
   <link rel="shortcut icon" href="images/personal.png">
	...
	<style>
		body{
			...
			background-image:url("https://cdn.dribbble.com/users/356550/screenshots/4085010/bettr-send-money.gif");
    ...
    <button class="primary_btn" style="float: left;" >HOME</button>
		...
		<div class="view">
			<form action="checkcredit.php" method="post" >
				...
				<table>	
					<tr>
						<td style="font-size:18pt;color:#010114;text-shadow: 1px 1px  black;">
							<label for="sender" align="left">From :</label>
						<label style="font-size:18pt;color:#010114;text-shadow: 1px 1px  black;text-align: left;"><?php echo $name1?></label>
			</td>
		</tr><br>	
					<tr>
       ...
       <tr>
			<td>
				...
				<br>
				<button type="submit" class="primary_btn" onMouseOver="this.style.color='yellow'"onMouseOut="this.style.color='black'" value="Credit" style="float: center;color:black;font-size:18px;">TRANSFER</button>
				</div>
				<br>
